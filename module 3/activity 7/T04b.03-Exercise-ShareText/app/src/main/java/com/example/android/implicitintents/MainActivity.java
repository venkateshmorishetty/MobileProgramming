...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String message = "hello this is working";
        shareText(message);
...
//        Toast.makeText(this, "TODO: Share text when this is clicked", Toast.LENGTH_LONG).show();
    ...
    // Do steps 2 - 4 within the shareText method
        public void shareText(String mes){
            String mimType = "text/plain";
            String title = "sharing";
            ShareCompat.IntentBuilder.from(this).setType(mimType).setChooserTitle(title).setText(mes).startChooser();
        }
